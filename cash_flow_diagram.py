...
class Drawer:
    ...
    def __init__(self,rd='data.xlsx', sheet_name='Cash Flow Diagram', title='Cash Flow Diagram', figsize=(5,4), legend1_loc='lower right', legend2_loc='upper right', title_fontweight='bold', colors=['#0000D9','#E63333','#FFCC33','#008000']):
        self.colors = colors
